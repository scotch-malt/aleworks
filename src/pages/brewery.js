                ...
                <div className="brewery-main">
                    ...
                    <div className="brewery-main-body">
                        ...
                        <div id="school" className="brewery-main-body-school">
                            ...
                            <p>330mlボトル／約48本</p>
                            <p>金額 49,800円（税込）</p>
                            <p style={{color: "red"}}>※決済はクレジットカードのみとなります。</p>
                            ...
                            <p>10:00　醸造体験・ビール醸造の説明</p>
                            <p>10:30　醸造作業の開始（麦芽を計って粉砕工程～マッシング）</p>
                            <p>11:30　糖化工程中お昼休憩</p>
                            <p>12:30　醸造作業の再開（マッシュタン洗浄、煮込み工程、ホップ投入、冷却、酵母投入立会い）</p>
                            <p>14:30　煮沸釜洗浄、ホース類洗浄、後片付け</p>
                            <p>15:30　醸造体験の終了</p>
